...
\newglossaryentry{glos:bruteforceLabel}{
	name=Bruteforce,
	description={
		Bruteforce (engl. \textit{brute force}, \textit{rohe Gewalt}) definiert das ausprobieren möglicher Kombinationen. Bei der Kryptografie ist dies eine sichere, jedoch ineffiziente Lösung um ein Passwort herauszufinden.
		%todo
		}
}
