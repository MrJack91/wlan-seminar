...
\newglossaryentry{glos:interfaceLabel}{
	name=Interface,
	description={
		Mit \textit{Interface} wird eine Netzwerkkarte bezeichnet. Das \textit{Interface} ermöglicht den Zugriff in ein bestehendes Netzwerk. Als Medium können verschiedene Datenträger unterstützt werden (Kabel, \textit{Wireless}, optische Datenträger, etc.).
	}
}
