...
In dieser Arbeit soll eine Übersicht über momentan verbreitete (sprich nicht nur den aktuellen) Wireless Security Standards und deren Schwachstellen aufgezeigt werden.
...
Zudem wird Fokus auf den \gls{wepLabel}-Standard (\chapref{ch:wep}), so wie den \gls{wpaLabel}-Standard (\chapref{ch:wpa}) gelegt. Beide Standards werden anhand konkreter Beispielen angegriffen.
